  ...
  return (
    <div className='my-4 w-full space-y-6'>
      ...
      <BoxedList title={_('Provider')} className={disabledSection}>
        ...
        <SettingsRow label={_('OpenRouter')} asLabel>
          <input
            type='radio'
            name='ai-provider'
            className='radio'
      ...
      {provider === 'openai' && (
        <BoxedList title={_('OpenAI Compatible Configuration')} className={disabledSection}>
          <div className='flex flex-col gap-2 py-3 pe-4'>
          ...
          <div className='flex flex-col gap-2 py-3 pe-4'>
            <SettingLabel>{_('Custom Request Parameters (JSON)')}</SettingLabel>
            <textarea
              className={clsx(
